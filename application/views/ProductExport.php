<div id="wrapper" ng-controller="ProductExportCtrl">

  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">นำออกสินค้า <a onclick="Reload();" href="<?php echo SITE_URL('ProductExport/ProductExportForm/'.$_SESSION['profileId'].'?profileId='.$_SESSION['profileId']); ?>"
