    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-money fa-fw"></i> ฝ่ายขาย<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#"> - ใบเสนอราคา</a>
                        </li>
                        <li>
                            <a href="#"> - การจัดการลูกค้า</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li>
                    <a href="#"><i class="fa fa-inbox fa-fw"></i> ฝ่ายจัดซื้อ<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#"> - ใบสั่งซื้อ</a>
                        </li>
                        <li>
                            <a href="#"> - การจัดการสินค้า</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
