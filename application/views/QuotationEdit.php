<div id="wrapper" ng-controller="QuotationEditCtrl">
        ...
        <div class="panel-body">
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <button ng-click="submit()" class="btn btn-warning btn-fill btn-block loading" data-loading-text="<i class='fa fa-spinner fa-spin'></i>"
                ng-disabled="(
